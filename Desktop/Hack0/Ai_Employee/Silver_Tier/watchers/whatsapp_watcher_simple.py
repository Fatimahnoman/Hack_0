...
Uses Bronze_Tier Vault at root level (same as Gmail Watcher)

Usage: python scripts/whatsapp_watcher_simple.py
"""
...
# Configuration - Using ROOT Bronze_Tier Vault (SAME AS GMAIL WATCHER)
PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent  # Goes to Ai_Employee root
...
def main():
    ...
    print("-" * 60)
    print("HOW TO USE:")
    print("1. Create a .txt or .md file in /Inbox with message content")
        ...
        while True:
            ...
            if os.path.exists(INBOX_FOLDER):
                ...
                for filename in files:
                    ...
                    # SKIP .md files (Gmail watcher already handles those)
